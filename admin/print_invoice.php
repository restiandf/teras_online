    ...
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-sm">
        ...
        <div class="text-center mb-8">
            <div class="flex items-center justify-center mb-4">
                <img src="../img/icon.png" alt="Logo" class="w-16 h-16 mr-4">
                <div>
            ...
            <div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between">
                        <p class="text-sm">
                            <span class="font-medium text-gray-600">Ekspedisi:</span>
                            <span class="text-gray-800"><?php echo htmlspecialchars($order['courier']); ?></span>
                        </p>
