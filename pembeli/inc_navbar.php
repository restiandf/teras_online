...
// Definisikan variabel $current_page
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                ...
                <div class="flex items-center">
                    <span class="self-center text-gray-900 mr-4 relative">
                        ...
                        <div id="userMenu" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 hidden">
                            ...
                            <a href="laporan.php" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">
            ...
            <?php else: ?>
                ...
                <a href="register.php">
                    <button
                        type="button"
                        class="text-white md:mr-4 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Daftar
                    </button>
                </a>
                <a href="login.php">
        ...
        <div
            ...
            <ul
                ...
                <li>
                    <a
                        href="../contact.php"
                        class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Kontak Kami</a>
                </li>
            </ul>
        </div>
    </div>
